...
<p align="center">
<h1 align="center"><strong>ReactiveBFM: Planificación Reactiva de Movimiento en Bucle Cerrado Hacia el Control Universal de Cuerpo Completo de Humanoides</strong></h1>
  <p align="center">
...
- [x] Lanzamiento del artículo de arXiv y de la página del proyecto en junio.
- [ ] Lanzamiento del código de entrenamiento y de inferencia sim2sim en agosto. (🚧 Actualmente en proceso de refactorización)
- [ ] Lanzamiento del código de despliegue en septiembre. (🚧 Actualmente en proceso de refactorización)
...
Si encuentran nuestro trabajo útil, por favor, citen:
